...
export default function Dashboard() {
    ...
    function parseFirebaseData(data) {
        ...
        for(let key in data.readings) {
            newH = (data.metaData.height - data.readings[key].waterLevel) / data.metaData.height;
            newV = Math.floor(newH * data.metaData.volume);
            dataX.push(key*1000);
            dataY.push(newV);
        }
...
// save the details in local storage of user, device list and maybe devicedata idk to get when going back and forth between home page and dashboard.