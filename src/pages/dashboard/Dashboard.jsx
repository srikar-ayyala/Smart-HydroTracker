...
export default function Dashboard() {
    ...
    function parseFirebaseData(data) {
        ...
        for(let key in data.readings) {
            dataX.push(key * 1000);
            const propHeight = (data.metaData.height - data.readings[key].waterLevel) / data.metaData.height;
            const vol = propHeight * data.metaData.volume;
            dataY.push(Math.floor(vol));
        }
