...
const About = forwardRef((props, ref) => {
    return <section ref={ref} className="about-section">
        ...
        <p>And so Smart HydroTracker helps you keep track of the amount of water you have in your tank at all times by sending the data directly to your smart devices. It is an easy, smart and secure way to manage your water levels and thus be aware of your water consumption levels</p>
